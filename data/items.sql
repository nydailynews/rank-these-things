...
# you're interested in the value of the id field for the new record you created.
SELECT * FROM ranker;
# Fine-tune this query next. Instead of the "2" that's on each line, use the id for the ranker you created.
